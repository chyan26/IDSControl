...
int analysisFocus(char* pMem, char* filename){
    ...
    line(img,minEllipse[1].center, minEllipse[3].center, color, 1, 8 );
    diff = minEllipse[1].center - minEllipse[3].center;
    res= cv::sqrt(diff.x*diff.x + diff.y*diff.y);
	printf("dist %f\n",res);



    line(img,minEllipse[2].center, minEllipse[3].center, color, 1, 8 );
    diff = minEllipse[2].center - minEllipse[3].center;
    res= cv::sqrt(diff.x*diff.x + diff.y*diff.y);
	printf("dist %f\n",res);

    line(img,minEllipse[2].center, minEllipse[0].center, color, 1, 8 );
    diff = minEllipse[2].center - minEllipse[0].center;
    res= cv::sqrt(diff.x*diff.x + diff.y*diff.y);
	printf("dist %f\n",res);
